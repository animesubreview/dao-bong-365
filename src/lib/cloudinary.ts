...
// Ưu tiên lấy từ biến môi trường VITE_CLOUDINARY_* nếu có, không thì dùng giá trị mặc định bên dưới.

const CLOUD_NAME = (import.meta.env.VITE_CLOUDINARY_CLOUD_NAME as string | undefined) || 'kjtnie8b';
