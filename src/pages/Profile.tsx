      ...
      <div className="px-4 pt-6 pb-5">
        ...
        {user ? (
          ...
          <div className="flex gap-3 mb-1">
            <Link to="/auth"
              className="flex-1 flex items-center justify-center gap-2 bg-green-500 hover:bg-green-400 text-slate-950 font-black py-3.5 rounded-2xl text-sm transition-all">
