        ...
        <div className="p-5 flex flex-col gap-5">
          ...
          <div>
            ...
            <button
              ...
              disabled={uploading}
              className="w-full flex items-center justify-center gap-2.5 bg-slate-800/80 border-2 border-dashed border-slate-600 hover:border-sky-500/60 rounded-2xl py-4 text-sm font-bold text-slate-300 hover:text-sky-400 transition-all disabled:opacity-60"
            >
              {uploading ? (
                <><Loader2 size={18} className="animate-spin text-sky-400" /> Đang tải lên...</>
              ) : (
                ...
                return (
                  <button
                    ...
                    className={`relative rounded-xl overflow-hidden aspect-square transition-all ${
                      isActive
                        ? 'ring-2 ring-sky-500 ring-offset-2 ring-offset-slate-900 scale-95'
                  ...
                  >
                    ...
                    {isActive && (
                      <div className="absolute inset-0 bg-sky-500/20 flex items-center justify-center">
                        <Check size={14} className="text-sky-400" strokeWidth={3} />
                      </div>
                    )}
                  </button>
                );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-10 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-24 left-1/3 w-80 h-80 bg-sky-500/4 rounded-full blur-3xl" />
        <div className="absolute bottom-16 right-1/4 w-72 h-72 bg-sky-600/6 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-slate-900/90 border border-slate-800/80 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl">
          ...
          <div className="px-6 pb-6">
            <div className="flex items-end gap-4 -mt-10 mb-6">
              <div className="relative shrink-0">
                ...
                <button
                  ...
                  className="absolute -bottom-1.5 -right-1.5 w-7 h-7 bg-sky-500 hover:bg-sky-400 rounded-lg flex items-center justify-center transition-all shadow-lg shadow-sky-500/30 active:scale-95"
                >
              ...
              {editingUsername ? (
                <div className="relative">
                  <input
                    ...
                    maxLength={30}
                    className="w-full bg-slate-800/80 border border-sky-500/40 rounded-xl py-3 px-4 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-500/40 transition-all pr-10"
                ...
                >
                  <span>{username}</span>
                  <Pencil size={13} className="text-slate-500 group-hover:text-sky-400 transition-colors" />
                </button>
              )}
            </div>
            ...
            <div className="mb-5">
              ...
              <button
                onClick={() => setShowAvatarPicker(true)}
                className="w-full flex items-center gap-3 bg-slate-800/60 border border-slate-700/50 hover:border-sky-500/40 rounded-xl py-3 px-4 text-sm transition-all group"
              >
                <img
                  src={pendingAvatar}
                  alt="current avatar"
                ...
                <ImagePlus size={15} className="text-slate-500 group-hover:text-sky-400 transition-colors shrink-0" />
              </button>
            </div>
            ...
            {hasChanges ? (
              <div className="flex gap-2.5">
                ...
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="flex-1 bg-sky-500 hover:bg-sky-400 text-slate-950 font-black py-3 rounded-xl text-sm transition-all shadow-lg shadow-sky-500/20 disabled:opacity-60 flex items-center justify-center gap-2"
                >
                  {saving ? (
        ...
        <div className="w-full max-w-sm mt-4">
          {/* Balance card */}
          <div className="bg-gradient-to-br from-green-600/20 via-green-500/10 to-indigo-600/10 border border-sky-500/20 rounded-2xl p-4 mb-3">
          ...
          {showVipShop && (
            <div className="mt-2 bg-slate-900/90 border border-amber-500/20 rounded-2xl p-4 flex flex-col gap-3">
              ...
              {vipMsg && (
                <div className={`text-xs text-center font-bold px-3 py-2 rounded-xl ${vipMsg.ok ? 'text-sky-400 bg-sky-500/10' : 'text-red-400 bg-red-500/10'}`}>
                  {vipMsg.text}
                </div>
              )}
          ...
          <a
            href="/nap-the"
            className="w-full flex items-center justify-between px-4 py-3 bg-slate-900/90 border border-slate-700/60 rounded-2xl text-sm font-bold text-white hover:border-sky-500/40 transition-all"
          >
            <div className="flex items-center gap-2">
