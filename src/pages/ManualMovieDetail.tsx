      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
          ...
          <div className="flex-1 md:pl-6 flex flex-col justify-end">
            ...
            <div className="flex md:hidden items-end gap-4 mb-4">
              ...
              <div className="pb-1">
                ...
                {movie.originName && (
                  <p className="text-yellow-400 text-xs font-semibold mt-0.5 line-clamp-1">{movie.originName}</p>
                )}
              </div>
            </div>
        ...
        <div className="mt-5 md:mt-6">
          <div className="hidden md:block mb-3">
            ...
            {movie.originName && (
              <p className="text-yellow-400 text-sm font-semibold mt-1">{movie.originName}</p>
            )}
          </div>
          ...
          {(movie.airingDay || movie.airingTime) && (
            <div className="flex items-center justify-between bg-slate-800/60 border border-slate-700/50 rounded-2xl px-5 py-3.5 mb-5">
              ...
              <button className="flex items-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-slate-950 font-black text-xs px-4 py-2 rounded-full transition-all active:scale-95 shadow-lg shadow-yellow-500/20">
                ...
                <div>
                  <div className="bg-slate-900/60 border border-slate-800/60 rounded-2xl p-5">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      <button className="text-[11px] font-black px-3 py-1.5 rounded-lg border flex items-center gap-1.5 bg-yellow-500/10 border-yellow-500/60 text-yellow-400">
                    ...
                    <div className="grid grid-cols-5 sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 gap-2">
                      {(movie.episodes && movie.episodes.length > 0
                        ...
                        <button
                          ...
                          className="bg-yellow-500 border-yellow-500 text-slate-950 py-2 rounded-lg text-center text-[11px] font-bold transition-all border shadow-md shadow-yellow-500/30 truncate px-1"
                        >
                          {ep.label}
                        </button>
                      ))}
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3">
                      {related.map(m => (
                        <Link key={m.id} to={`/manual/${m.id}`} className="group block">
                          <div className="rounded-xl overflow-hidden bg-slate-800 border border-slate-700/40 group-hover:border-yellow-500/40 transition-all" style={{ aspectRatio: '2/3' }}>
                            {m.posterUrl
                          ...
                          <div className="mt-1.5 px-0.5">
                            <div className="truncate font-bold text-[12px] text-slate-200 group-hover:text-yellow-400 transition-colors">{m.name}</div>
