...
import { MessageSquareText, Heart, Shield, TrendingUp, ArrowUp, ArrowDown, Minus } from 'lucide-react';
import { getRecentComments, getCommentCountsSince } from '../lib/comments';
