  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 md:p-10 max-w-2xl z-10">
        ...
        <p className="text-green-400 text-sm font-bold mb-3 line-clamp-1">
        ...
        <div className="flex flex-wrap items-center gap-1.5 mb-4">
          {movie.quality && (
            <span className="text-[10px] font-black bg-green-500 text-slate-950 px-1.5 py-0.5 rounded">
              {movie.quality}
            </span>
          )}
          {movie.year && (
        ...
        <div className="flex gap-3">
          <Link to={`/phim/${movie.slug}`}
            className="flex items-center gap-2 bg-green-500 hover:bg-green-400 text-slate-950 font-black px-6 py-2.5 rounded-full text-sm transition-all active:scale-95 shadow-lg">
